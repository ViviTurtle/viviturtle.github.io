...
This spectrogram was created using [Sonic Visualizer](https://www.sonicvisualiser.org/download.html) which I discovered during the [QueerCon Puzzle]({{site.url}}/blog/ctf/stego/crypto/QC13-Soundcheck) I had mentioned before. Since 2016, it has gone through a major rehaul and is very intuitive to use. I  can actually scroll, zoom, and export the Spectrogram using this tool. So much better than using:
...
<div class="album">
   <figure>
    ...
    <figure>
      <img src="{{ site.github.url }}/images/openctf2019/Sheet-Music.png" />
       <figcaption>Sheet Music</figcaption>
   </figure>
</div>
...
<figure>
<object data="https://drive.google.com/file/d/1DNGZlBBBd6XHL2lImybJYirUrCL-Gt53/preview"  width="450" height="375">
    <embed src="https://drive.google.com/file/d/1DNGZlBBBd6XHL2lImybJYirUrCL-Gt53/preview" width="450px" height="375px" />
